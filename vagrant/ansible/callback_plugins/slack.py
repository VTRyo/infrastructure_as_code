...
class CallbackModule(CallbackBase):
    ...
    def set_options(self, options):
        ...
        self.webhook_url = self._plugin_options['T0T053S4Q/B65JQ6Z5F/tIZxr62uDdpNx9LpDmhDHNFJ']
        self.channel = self._plugin_options['infra_sre']
        self.username = self._plugin_options['ansible']
